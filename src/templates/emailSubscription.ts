...
export const emailSubscriptionHTMLTemplate = (
...
<tr>
<td align="left" class="es-p20">${prices.reduce(
  (str, priceInfo) =>
    str + `<p>${priceInfo.symbol}: ${priceInfo.price} USDT</p>`,
  '',
)}</td>
</tr>
</table></td>
...
<table cellpadding="0" cellspacing="0" width="100%" role="presentation">
<tr>
<td align="left"><p>Thanks,<br>TraneTrade</p></td>
</tr>
<tr>
