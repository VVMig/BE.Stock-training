...
<table cellpadding="0" cellspacing="0" width="100%" role="presentation">
<tr>
<td align="left" class="es-m-txt-c" style="font-size: 0px"><a target="_blank" href="#"><amp-img src="https://glisox.stripocdn.email/content/guids/CABINET_ee77850a5a9f3068d9355050e69c76d26d58c3ea2927fa145f0d7a894e624758/images/group_4076323.png" alt="Confirm email" style="display: block;border-radius: 100px" width="100" title="Confirm email" height="100"></amp-img></a></td>
</tr>
</table></td>
</tr>
</table></td>
...
<tr>
<td align="left" class="es-p20"><h3>Welcome,&nbsp;${name}</h3><p><br></p><p>You're receiving this message because you recently signed up for a account.<br><br>Confirm your email address by clicking the button below. This step adds extra security to your account by verifying you own this email.</p></td>
</tr>
</table></td>
</tr>
</table></td>
...
<![endif]-->
<!--[if !mso]><!-- --><span class="msohide es-button-border" style="display: block;background: #7630f3"><a href="${url}" class="es-button msohide" target="_blank" style="padding-left: 5px;padding-right: 5px;display: block;background: #7630f3;border-color: #7630f3">Confirm email</a></span>
<!--<![endif]--></td>
</tr>
</table></td>
</tr>
